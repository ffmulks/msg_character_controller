...
pub fn gravity_settings_ui(ui: &mut egui::Ui, controller: &mut CharacterController) {
    ui.collapsing("Gravity Settings", |ui| {
        ui.horizontal(|ui| {
            ui.label("Gravity X:");
            ui.add(egui::DragValue::new(&mut controller.gravity.x).speed(10.0));
        });
        ui.horizontal(|ui| {
            ui.label("Gravity Y:");
            ui.add(egui::DragValue::new(&mut controller.gravity.y).speed(10.0));
        });
    });
}
...
pub fn float_settings_ui(ui: &mut egui::Ui, config: &mut ControllerConfig) {
    ui.collapsing("Float Settings", |ui| {
        ui.horizontal(|ui| {
            ...
            ui.add(egui::DragValue::new(&mut config.float_height).speed(0.1));
        });
        ui.horizontal(|ui| {
            ui.label("Ground Tolerance:");
            ui.add(egui::DragValue::new(&mut config.ground_tolerance).speed(0.1));
        });
        ui.horizontal(|ui| {
            ui.label("Cling Distance:");
            ui.add(egui::DragValue::new(&mut config.cling_distance).speed(0.1));
        });
        ui.horizontal(|ui| {
            ui.label("Cling Strength:");
            ui.add(egui::DragValue::new(&mut config.cling_strength).speed(0.01));
        });
    });
}
...
pub fn spring_settings_ui(ui: &mut egui::Ui, config: &mut ControllerConfig) {
    ui.collapsing("Spring Settings", |ui| {
        ui.horizontal(|ui| {
            ...
            ui.add(egui::DragValue::new(&mut config.spring_strength).speed(100.0));
        });
        ui.horizontal(|ui| {
            ui.label("Spring Damping:");
            ui.add(egui::DragValue::new(&mut config.spring_damping).speed(10.0));
        });
        ...
        ui.horizontal(|ui| {
            ...
            if has_max_force {
                if ui
                    .add(egui::DragValue::new(&mut max_force).speed(100.0))
                    .changed()
                {
        ...
        ui.horizontal(|ui| {
            ...
            if has_max_vel {
                if ui
                    .add(egui::DragValue::new(&mut max_vel).speed(1.0))
                    .changed()
                {
...
pub fn movement_settings_ui(ui: &mut egui::Ui, config: &mut ControllerConfig) {
    ui.collapsing("Movement Settings", |ui| {
        ui.horizontal(|ui| {
            ui.label("Max Speed:");
            ui.add(egui::DragValue::new(&mut config.max_speed).speed(1.0));
        });
        ui.horizontal(|ui| {
            ui.label("Acceleration:");
            ui.add(egui::DragValue::new(&mut config.acceleration).speed(10.0));
        });
        ui.horizontal(|ui| {
            ui.label("Friction:");
            ui.add(egui::DragValue::new(&mut config.friction).speed(0.01));
        });
        ui.horizontal(|ui| {
            ui.label("Air Control:");
            ui.add(egui::DragValue::new(&mut config.air_control).speed(0.01));
        });
    });
}
...
pub fn slope_settings_ui(ui: &mut egui::Ui, config: &mut ControllerConfig) {
    ui.collapsing("Slope Settings", |ui| {
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add(egui::DragValue::new(&mut angle_deg).speed(1.0))
                .changed()
            {
        ...
        ui.horizontal(|ui| {
            ...
            ui.add(egui::DragValue::new(&mut config.uphill_gravity_multiplier).speed(0.1));
        });
    });
}
...
pub fn sensor_settings_ui(ui: &mut egui::Ui, config: &mut ControllerConfig) {
    ui.collapsing("Sensor Settings", |ui| {
        ui.horizontal(|ui| {
            ...
            ui.add(egui::DragValue::new(&mut config.ground_cast_multiplier).speed(0.1));
        });
        ui.horizontal(|ui| {
            ui.label("Ground Cast Width:");
            ui.add(egui::DragValue::new(&mut config.ground_cast_width).speed(0.1));
        });
        ui.horizontal(|ui| {
            ui.label("Wall Cast Mult:");
            ui.add(egui::DragValue::new(&mut config.wall_cast_multiplier).speed(0.1));
        });
        ui.horizontal(|ui| {
            ui.label("Wall Cast Height:");
            ui.add(egui::DragValue::new(&mut config.wall_cast_height).speed(0.1));
        });
        ui.horizontal(|ui| {
            ui.label("Ceiling Cast Mult:");
            ui.add(egui::DragValue::new(&mut config.ceiling_cast_multiplier).speed(0.1));
        });
        ui.horizontal(|ui| {
            ui.label("Ceiling Cast Width:");
            ui.add(egui::DragValue::new(&mut config.ceiling_cast_width).speed(0.1));
        });
    });
}
...
pub fn jump_settings_ui(ui: &mut egui::Ui, config: &mut ControllerConfig) {
    ui.collapsing("Jump Settings", |ui| {
        ui.horizontal(|ui| {
            ui.label("Jump Speed:");
            ui.add(egui::DragValue::new(&mut config.jump_speed).speed(100.0));
        });
        ui.horizontal(|ui| {
            ui.label("Coyote Time:");
            ui.add(egui::DragValue::new(&mut config.coyote_time).speed(0.01));
        });
        ui.horizontal(|ui| {
            ui.label("Jump Buffer Time:");
            ui.add(egui::DragValue::new(&mut config.jump_buffer_time).speed(0.01));
        });
        ui.horizontal(|ui| {
            ui.label("Extra Fall Gravity:");
            ui.add(egui::DragValue::new(&mut config.extra_fall_gravity).speed(0.1));
        });
    });
}
...
pub fn upright_torque_settings_ui(ui: &mut egui::Ui, config: &mut ControllerConfig) {
    ui.collapsing("Upright Torque Settings", |ui| {
        ...
        ui.horizontal(|ui| {
            ...
            ui.add(egui::DragValue::new(&mut config.upright_torque_strength).speed(10.0));
        });
        ui.horizontal(|ui| {
            ui.label("Torque Damping:");
            ui.add(egui::DragValue::new(&mut config.upright_torque_damping).speed(1.0));
        });
        ...
        ui.horizontal(|ui| {
            ...
            if has_target {
                if ui
                    .add(egui::DragValue::new(&mut target_deg).speed(1.0))
                    .changed()
                {
        ...
        ui.horizontal(|ui| {
            ...
            if has_max_torque {
                if ui
                    .add(egui::DragValue::new(&mut max_torque).speed(1.0))
                    .changed()
                {
        ...
        ui.horizontal(|ui| {
            ...
            if has_max_vel {
                if ui
                    .add(egui::DragValue::new(&mut max_vel).speed(0.1))
                    .changed()
                {
